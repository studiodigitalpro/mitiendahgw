...
export const PRODUCTS: Product[] = [
  // 1. Blueberry Candy
  {
    ...
    pricePartner: 4.00,
    bv: 2.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/BLUEBERRY-CANDY-HGW.webp',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Blueberry-Candy.jpg',
  ...
  // 2. Blueberry Fruit Tea (Jam)
  {
    ...
    pricePartner: 8.00,
    bv: 4.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/mermelada-p-500.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/mermelada-de-arandanos-hgw.webp',
  ...
  // 3. Blueberry Collagen Peptide
  {
    ...
    pricePartner: 20.00,
    bv: 12.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/colageno-p-500.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Peptidos-de-Colageno-con-Arandano-HGW.jpg',
  ...
  // 4. Fresh Drink Chang JingJing
  {
    ...
    category: 'alimentos',
    categoryLabel: 'Alimentos y Bebidas',
    shortDescription: 'Selecta infusión herbal alcalinizante formulada para la limpieza profunda y suave del tracto digestivo.',
    description: 'Bebida refrescante elaborada según los principios de la medicina tradicional oriental. Su exclusiva combinación de pasto de cebada, bayas de goji, Gan Cao (regaliz), diente de león y crisantemo ayuda a remover costras fecales, alcalinizar el organismo y descongestionar el colon e hígado.',
    pricePublic: 13.00,
    pricePartner: 9.00,
    bv: 5.40,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/fresh-drink-p-500.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Fresh-Drink-Chang-Jing-Jing.jpg',
  ...
  // 5. Pro Shaping Tea
  {
    ...
    category: 'alimentos',
    categoryLabel: 'Alimentos y Bebidas',
    shortDescription: 'Té termogénico y desintoxicante de alta pureza para el control de peso y activación metabólica.',
    description: 'Pro Shaping Tea HGW es una selecta infusión de hierbas medicinales orientales formulada para estimular el metabolismo lipídico, facilitar la digestión de grasas, drenar retención de líquidos y estilizar la figura de manera 100% natural.',
    pricePublic: 23.00,
    pricePartner: 16.00,
    bv: 9.60,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/proshaping-p-500.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/te-moldeador-profesional-hgw.webp',
  ...
  // 6. Berry Juice HIGH VC
  {
    ...
    pricePartner: 17.00,
    bv: 8.50,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/berry-juice-p-500.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Berry-Juice-High-VC-Jugo-de-Arandanos-Rico-en-Vitamina-C.jpg',
  ...
  // 7. Blueberry Wine
  {
    ...
    pricePartner: 26.00,
    bv: 5.20,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Vino-de-arandanos-HGW.jpg',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/vino-de-arandanos-hgw.webp',
  ...
  // 8. Trébol Coffee
  {
    ...
    shortDescription: 'Café gourmet enriquecido con extractos de trébol y plantas medicinales para equilibrio hormonal y bienestar.',
    ...
    pricePartner: 16.00,
    bv: 8.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/trebol.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Cafe-Trebol-HGW.jpg',
    ...
    ingredients: ['Café soluble arábica', 'Extracto de trébol rojo medicinal', 'Crema no láctea de origen vegetal'],
  ...
  // 9. Cordyceps Coffee Cream
  {
    ...
    description: 'Cordyceps Coffee Cream HGW es ideal para deportistas, profesionales y personas con alta exigencia física y mental. El hongo Cordyceps es venerado en la medicina oriental por incrementar la absorción de oxígeno celular (ATP), optimizar el rendimiento atlético y respaldar las vías respiratorias y riñones.',
    pricePublic: 23.00,
    pricePartner: 16.00,
    bv: 9.60,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Cordyceps-Coffee.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Cafe-con-cordyceps.jpg',
    presentation: 'Caja con 12 sobres de 15 gramos c/u (180 g)',
    benefits: [
  ...
  // 10. BlackTea Coffee
  {
    ...
    pricePartner: 14.00,
    bv: 7.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/black-tea-p-500.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Cafe-con-Te-Negro-BlackTea-Coffee.jpg',
  ...
  // 11. Coffee Ceps
  {
    ...
    pricePartner: 14.00,
    bv: 7.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/cofee-ceps-p-500.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Cafe-Cordyceps-Coffee-Ceps.jpg',
    presentation: 'Caja con 12 sobres de 3.5 gramos c/u (42 g)',
    benefits: [
  ...
  // 12. Blueberry Coffee
  {
    ...
    pricePartner: 16.00,
    bv: 9.60,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/blueberry-coffee-p-500.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Cafe-de-arandanos.jpg',
    presentation: 'Caja con 12 sobres de 15 gramos c/u (180 g)',
    benefits: [
  ...
  // 13. Lactiberry
  {
    ...
    pricePartner: 18.00,
    bv: 9.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/lactiberry-p-500.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Lactiberry-HGW.jpg',
  ...
  // 14. Ashwaganda Coffee
  {
    ...
    pricePartner: 16.00,
    bv: 8.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/aswaganda-coffee.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Cafe-de-Ashwagandha.jpg',
    presentation: 'Caja con 12 sobres de 15 gramos c/u (180 g)',
    benefits: [
  ...
  // 15. Ganoderma Soluble Coffee
  {
    ...
    pricePartner: 16.00,
    bv: 9.60,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/ganoderma-p-500.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Cafe-soluble-de-Ganoderma-HGW.jpg',
    presentation: 'Caja con 12 sobres de 15 gramos c/u (180 g)',
    benefits: [
  ...
  // 16. Blueberry Soy Protein Powder
  {
    ...
    pricePartner: 25.00,
    bv: 15.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/proteina-de-soya-p-500.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Proteina-de-soja-con-arandano-en-polvo-HGW.jpg',
    presentation: 'Caja con 10 sobres de 30 gramos c/u (300 g)',
    benefits: [
  ...
  // 17. Ganoderma Candy
  {
    ...
    pricePartner: 5.80,
    bv: 2.90,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Ganubi-Candy-HGW-scaled.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Ganoderma-Candy-HGW.jpg',
  ...
  // 18. Coffee Candy
  {
    ...
    pricePartner: 4.00,
    bv: 2.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Coffee-Candy-HGW-scaled.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Coffee-Candy-HGW.jpg',
    presentation: 'Frasco con 60 caramelos',
    benefits: [
  ...
  // 19. Biolacti Candy
  {
    ...
    pricePartner: 4.00,
    bv: 2.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Biolacti-Candy-scaled.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/biolacti-candy-p-500.png',
    presentation: 'Frasco con 60 caramelos',
    benefits: [
  ...
  // 20. Gestifruit Candy
  {
    ...
    pricePartner: 4.00,
    bv: 2.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Gestifruit-Candy-HGW-scaled.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/gestifruit-candy-p-500.png',
    presentation: 'Frasco con 60 caramelos',
    benefits: [
  ...
  // 21. Peptipro Candy
  {
    ...
    pricePartner: 4.00,
    bv: 2.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Peptipro-Candy-HGW-scaled.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/peptipro-candy-p-500.png',
    presentation: 'Frasco con 60 caramelos',
    benefits: [
  ...
  // 22. Herbal Fresh Candy
  {
    ...
    category: 'serie-candy',
    categoryLabel: 'Serie Candy HGW',
    shortDescription: 'Caramelos balsámicos con extractos de hierbas medicinales chinas para despejar garganta y vías aéreas.',
    ...
    pricePartner: 4.00,
    bv: 2.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/HERBAL-FRESH-CANDY-HGW.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Herbal-Fresh-Candy-HGW.jpg',
    presentation: 'Frasco con 60 caramelos',
    benefits: [
  ...
  // 23. Moruva Candy
  {
    ...
    pricePartner: 4.00,
    bv: 2.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Moruva-candy-HGW-scaled.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Moruva-Candy-HGW.jpg',
    presentation: 'Frasco con 60 caramelos',
    benefits: [
  ...
  // 24. Choco Blue
  {
    ...
    pricePartner: 28.00,
    bv: 11.20,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Choco_Blue_HGW-removebg-preview.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/choco-blue-hgw.png',
  ...
  // 25. Choco Gano
  {
    ...
    pricePartner: 28.00,
    bv: 11.20,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Choco_Gano_HGW-removebg-preview.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Choco-gano-hgw.png',
    presentation: 'Caja con 20 sobres de 33 gramos c/u (660 g)',
    benefits: [
  ...
  // 26. Spirulina Plus Capsule
  {
    ...
    pricePartner: 17.00,
    bv: 8.50,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Spirulina-en-capsulas-Plus-con-Gingseng-HGW.jpg',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Spirulina-Plus-Capsule.jpg',
  ...
  // 27. Tourmaline Healthcare Insoles
  {
    ...
    pricePartner: 6.00,
    bv: 3.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Plantillas-de-Turmalina-HGW.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Plantillas-de-Turmalina-HGW.jpg',
  ...
  // 28. Tourmaline Self-Heating Knee Protector
  {
    ...
    category: 'accesorios',
    categoryLabel: 'Accesorios y Bienestar',
    shortDescription: 'Rodillera terapéutica autocalentable con matriz de turmalina e imanes magnéticos para aliviar el dolor articular.',
    description: 'La Rodillera con Turmalina HGW utiliza calor natural infrarrojo profundo generado por el propio calor corporal en contacto con la turmalina y campos biomagnéticos. Alivia dolores de rodilla, artrosis, rigidez articular, desinflama tendones y acelera la recuperación post-entrenamiento.',
    pricePublic: 55.00,
    pricePartner: 39.00,
    bv: 15.60,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/protector_de_rodilla_hgw-removebg-preview.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Rodillera-de-turmalina-hgw.webp',
  ...
  // 29. Tourmaline Waist Protector
  {
    ...
    pricePartner: 48.00,
    bv: 19.20,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/protector_de_cintura_hgw-removebg-preview.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Protector-de-cintura-de-turmalina.jpg',
    ...
    ingredients: ['Tejido elástico de alta compresión', 'Placa de turmalina autocalentable', 'Imanes terapéuticos'],
  ...
  // 30. Tourmaline Self-Heating Neck Protector
  {
    ...
    pricePartner: 11.00,
    bv: 4.40,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Protector_de_cuello_con_turmalina_HGW-removebg-preview.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Protector-de-cuello-de-turmalina.jpg',
    presentation: '1 unidad (Ajuste ergonómico de velcro)',
    benefits: [
      'Genera calor terapéutico focalizado en vértebras cervicales en 15 minutos',
  ...
  // 31. Toalla Sanitaria Noche
  {
    ...
    pricePartner: 3.20,
    bv: 1.60,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Toalla-sanitaria-con-turmalina-HGW-uso-nocturno.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/toalla-sanitaria-de-noche-hgw.webp',
  ...
  // 32. Protector Diario
  {
    ...
    pricePartner: 3.50,
    bv: 1.70,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Protectores-intimos-HGW.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/protector-diario-hgw.webp',
    ...
    ingredients: ['Capa de algodón suave transpirable', 'Chip central con nanotecnología de turmalina y aniones', 'Adhesivo grado médico'],
  ...
  // 33. Toalla Sanitaria Día
  {
    ...
    pricePartner: 3.50,
    bv: 1.70,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Toalla-sanitaria-con-turmalina-HGW-uso-dia.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/toalla-sanitaria-de-dia-hgw.webp',
  ...
  // 34. Press On Nails
  {
    ...
    pricePartner: 6.00,
    bv: 1.20,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Press-on-nails-unas-hgw.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Press-On-Nails-HGW.jpg',
  ...
  // 35. Pulsera de Tourmalina Versión Limitada (Códigos 51 al 57)
  {
    ...
    pricePartner: 15.00,
    bv: 9.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Pulsera-de-Tourmalina-Version-limitada-Codigo-del-51-al-57.jpg',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/pulsera-turmalina-p-500.png',
  ...
  // 36. Colgante Piedra Energética
  {
    ...
    pricePartner: 35.00,
    bv: 21.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Colgante-Piedra-Energetica-HGW.jpg',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/colgante-piedra-p-500.png',
  ...
  // 37. Collar de Tourmalina Versión Limitada (del 51 al 57)
  {
    ...
    pricePartner: 30.00,
    bv: 18.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Collar-de-Tourmalina-Version-limitada-del-51-al-57.jpg',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/collar-turmalina-p-500.png',
  ...
  // 38. Collar de Tourmalina Clásico
  {
    ...
    pricePartner: 28.00,
    bv: 16.80,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Collar-de-Tourmalina-HGW.jpg',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/collar-clasico-p-500.png',
  ...
  // 39. Pulsera de Tourmalina Clásica
  {
    ...
    pricePartner: 14.00,
    bv: 8.40,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Pulsera-de-Tourmalina-HGW.jpg',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/pulsera-clasica-p-500.png',
  ...
  // 40. Tourmaline Thermo (WATERSON)
  {
    ...
    pricePartner: 65.00,
    bv: 32.50,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Thermo_de_turmalina-removebg-preview.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Termo-alcalinizador-de-agua-con-turmalina-WATERSON-HGW.jpg',
  ...
  // 41. Coffee Cup
  {
    ...
    pricePartner: 18.00,
    bv: 7.20,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Coffee_Cup-removebg-preview.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Coffee-Cup-Taza-termica-para-Cafe.jpg',
    ...
    ingredients: ['Acero inoxidable grado alimenticio', 'Silicona médica libre de BPA'],
  ...
  // 42. Hervidor Eléctrico
  {
    ...
    pricePartner: 42.00,
    bv: 8.40,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Hervidor_electrico-removebg-preview.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Hervidor-Electrico-HGW.jpg',
  ...
  // 43. Vaso Térmico
  {
    ...
    pricePartner: 22.00,
    bv: 8.80,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Vaso_termico-removebg-preview.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Vaso-Termico-HGW.jpg',
    presentation: '1 unidad',
    benefits: [
  ...
  // 44. Tourmaline Magnet Pillow
  {
    ...
    pricePartner: 62.00,
    bv: 18.60,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Almohada_de_turmalina-removebg-preview.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Almohada-magnetica-de-turmalina-HGW.jpg',
    ...
    ingredients: ['Espuma viscoelástica memory foam', 'Núcleo de turmalina y aniones', 'Imanes biomagnéticos terapéuticos'],
  ...
  // 45. Pen Gel
  {
    ...
    pricePartner: 1.00,
    bv: 0.30,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Pen-Gel.jpg',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/Boligrafo-punta-Gel-HGW.jpg',
  ...
  // 46. Pasta dental con turmalina Negra
  {
    ...
    pricePartner: 5.00,
    bv: 3.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Pasta_dental_con_turmalina_negra-removebg-preview.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/pasta-dental-con-turmalina-negra-hgw.webp',
  ...
  // 47. Pasta dental con turmalina Blanca
  {
    ...
    pricePartner: 5.00,
    bv: 3.00,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Pasta-dental-con-turmalina-blanca-ong.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/pasta-dental-con-turmalina-blanca-hgw.webp',
    presentation: 'Tubo de 120 gramos',
    benefits: [
  ...
  // 48. Pasta dental con probiótico
  {
    ...
    pricePartner: 5.00,
    bv: 2.50,
    image: 'https://hgwpanama.com/wp-content/uploads/2026/08/Pasta-dental-con-probioticos-HGW-png.png',
    fallbackImage: 'https://hgwpanama.com/wp-content/uploads/2026/08/pasta-dental-con-probioticos-hgw.webp',
    presentation: 'Tubo de 120 gramos',
    benefits: [
